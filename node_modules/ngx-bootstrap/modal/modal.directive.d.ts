...
export declare class ModalDirective implements OnDestroy, OnInit {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<ModalDirective, "[bsModal]", ["bs-modal"], { "config": "config"; "closeInterceptor": "closeInterceptor"; }, { "onShow": "onShow"; "onShown": "onShown"; "onHide": "onHide"; "onHidden": "onHidden"; }, never, never, false, never>;
}
